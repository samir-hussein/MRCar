            ...
            <div class="twt-feed blue-bg">
                ...
                <div class="media">
                    ...
                    <div class="media-body">
                        <h2 class="text-white display-6" id="h-name">{{ Auth::user()->name }}</h2>
    ...
    <div class="col-xl-8 col-lg-6">
        <div class="card">
            ...
            <div class="card-body card-block">
                <form id="name-form" action="{{ route('admin.update') }}" method="post">
                    @csrf
        ...
        <div class="card">
            ...
            <div class="card-body card-block">
                <form id="password-form" action="{{ route('admin.update') }}" method="post">
                    @csrf
                    <div class="form-group">
